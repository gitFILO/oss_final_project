...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "userInWorkspace" ADD CONSTRAINT "userInWorkspace_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
