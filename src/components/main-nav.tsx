  ...
  return (
    <div className="flex items-center space-x-10">
      ...
      <NavigationMenu className="ml-10">
        <NavigationMenuList className="m-0  space-x-3">
          <NavigationMenuItem>
            <NavigationMenuTrigger>팀 스페이스 가입</NavigationMenuTrigger>
            <NavigationMenuContent>
              <Dialog>
                <DialogTrigger className="w-[150px] h-[50px]">
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent
              className="overflow-y-auto py-3 flex flex-col relative justify-center"
            ...
            >
              ...
              <ScrollArea className="h-[300px] w-full overflow-x-hidden">
                <ul className="list-none grid gap-3 py-2 lg:grid-cols-[1fr]">
                  {currentUserTeamSpace ? (
